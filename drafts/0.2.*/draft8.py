import random
from utils.utilities import colourprint, typingprint, typinginput, cards, clear, wait, instructions, color
...
def prepare_game_deck(num_players):
    ...
    typingprint(
        f"{CYAN}Each player will get {BOLD}{cards_per_player}{END}{CYAN} cards.{END}"
    )
...
def show_cards(player):
    ...
    typingprint(
        "{RED}{BOLD}Make sure all other players are looking away!{END}")
    wait(5)
